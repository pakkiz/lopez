...
PM_START_TEXT = """
ഹായ് എനിക്ക് നിങ്ങളെ സഹായിക്കാൻ കഴിയില്ല, കാരണം എന്നെ ഉണ്ടാക്കിയിരിക്കുന്നത് പൂർണമായും [MC Movie World Group](https://t.me/mc_movieworld_group) നിയന്ത്രിക്കാൻ മാത്രമാണ്.. നിങ്ങൾക്ക് എന്നെ മറ്റൊരു ഗ്രൂപ്പിലും കയറ്റാൻ സാധ്യമല്ല.. എന്നെ പറ്റി എന്തെങ്കിലും അറിയണം എന്നുണ്ടെങ്കിൽ എന്റെ [മുതലാളിയെ](tg://user?id=1032950539) സമീപിക്കുന്നതാണ്..   നിങ്ങളെ ഞാൻ എന്റെ എന്റെ [ഗ്രൂപ്പിലേക്ക്](https://t.me/mc_movieworld_group) ക്ഷണിക്കുന്നു...
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1032950539 and DONATION_LINK:
...
def main():
    ...
    help_handler = CommandHandler("MC", get_help)
