...
RUN_STRINGS = (
    ...
    "ദൈവമേ എന്നെയും എന്റെ മുതലാളി മണവാളനെയും മാത്രം രക്ഷിക്കണേ......",
    ...
    "ഇവിടെ കിടന്നെങ്ങാനും ഷോ  കാണിക്കാനാണ് ഭാവം എങ്കിൽ കാലേ വാരി ഭിത്തിയിൽ ഒട്ടിക്കും, മുതലാളി പറയാൻ പറഞ്ഞ്",
    "എന്റെ മുതലാളി പോളിയാണ് കിടുവാണ് അന്യായമാണ്",
    "മേരെ പ്യാരി ദേശ് വാസിയോം....",
    "ഞാൻ ചിട്ടി, വെർഷൻ 3.O..."
    )
...
SLAP_TEMPLATES = (
    ...
    "{user1}.. എന്റെ മുതലാളി പറഞ്ഞിട്ടുണ്ട് വെറുതെ ഒന്നും ആരെയും തല്ലരുതെന്ന്.. {user2} പാവമല്ലേ..."
)
...
def info(bot: Bot, update: Update, args: List[str]):
    ...
    if user.id == OWNER_ID:
        text += "\n\nഇദ്ദേഹത്തെ അറിയില്ലേ ഇദ്ദേഹം ആണ് സാക്ഷാൽ മുതലാളി.. ഇദ്ദേഹത്തെ എനിക്ക് ഒന്നും ചെയ്യാൻ പറ്റില്ല....."
    else:
        if user.id in SUDO_USERS:
            text += "\n\nഇയാൾ എന്റെ മുതലാളിയുടെ കൂട്ടുകാരൻ ആണ് 😋" \
